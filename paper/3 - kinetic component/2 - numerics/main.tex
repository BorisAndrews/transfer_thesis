\section{Numerics}
 ...
 \left[\overline{\bfV} + \delta\bfV\right]dt  \\
    ...
    \BA{In hindsight, I ought to go directly by just figuring out the evolution equations for the energy/gyrocentre/magnetic moment. I can do this for all kinds of random motion too (Lévy flight etc.).}
