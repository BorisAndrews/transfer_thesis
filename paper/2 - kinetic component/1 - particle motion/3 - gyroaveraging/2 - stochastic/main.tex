\subsubsection*{Stochastic Gyrokinetic Theory}
    ...
    \begin{align}
        \rmd\bfx_{\rmg}  &=  \left\{\cdots\tall\right\}\rmd t \mp \frac{\rmm_{\pm}}{\rme}\cdot\frac{1}{B}\left(\frac{\lambda_{\pm}}{B}\bfu\wedge\bfB\rmd t + \sigma_{\pm}\left(\sfI - \frac{1}{B^{2}}\bfB^{\otimes 2}\right)\rmd\widetilde{\bfW}\right)   \\
                 \rmd E  &=  \left\{\cdots\tall\right\}\rmd t + \lambda_{\pm}(m_{\pm}u_{\parallel}V_{\parallel} - 2E)\rmd t + \frac{3\rmm_{\pm}}{2}\sigma_{\pm}^{2}\rmd t + \rmm_{\pm}(V_{\parallel}\rmd W_{\parallel} + V_{\perp}\rmd W_{\perp})  \\
                \rmd\mu  &=  \left\{\cdots\tall\right\}\rmd t \pm \rme\left(- \frac{2}{\rmm_{\pm}}\lambda_{\pm}\mu\rmd t + \frac{\sigma_{\pm}V_{\perp}}{B}dW_{\perp}\right)
    \end{align}
    where similarly $\bfu$, $\lambda_{\pm}$, $\sigma_{\pm}$ are evaluated at the gyrocenter, $\bfx_{\rmg}$, and $\widetilde{\bfW}$ is a distinct Wiener process, independent of $\bfW$. \BA{(Proof of independence? Definitions of $V_{\parallel}$, $V_{\perp}$?)}
