\section{Coupled Fluid/Correction Models: A \emph{Low} Collisionality Concept}
    ...
    \subsubsection*{Fluid Background: A \emph{Fluid} Model}
        ...
        \BA{Often for high-energy species in tokamak plasmas, it might even be the case that the background would be better modelled using, say a damped Maxwellian (see figure \ref{sharp cut-off energy distributions}) like the ones I implemented in GENE, due to Alfvénic damping.}
