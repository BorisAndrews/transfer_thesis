\chapter{Physical Model and System of Equations}
    ...
    \begin{itemize}
        ...
        \end{itemize}
        \item  Only (thermalising) Coulomb collisions are considered- these are generally dominant over the others in a tokamak. (N.B. No fusion.)
    ...
    \input{1 - physical model and system of equations/1 - tokamak plasma dynamics/main.tex}
    \input{1 - physical model and system of equations/2 - kinetic models/main.tex}
    \input{1 - physical model and system of equations/3 - fluid models/main.tex}
    \input{1 - physical model and system of equations/4 - coupled fluid correction models/main.tex}
    \input{1 - physical model and system of equations/5 - edge plasma model/main.tex}
