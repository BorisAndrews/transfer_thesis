\section{Physical Model and System of Equations}
    ...
    \subsection{Kinetic Models}
        ...
        \subsubsection{Tozmahok Plasmas}
            \BA{Why the fluid/MHD model reductions aren't necessarily valid in tozmahok plasmas. (Incorrectly assumed dominant collisional term- get some estimates on the scale of these terms in the edge plasma. Good content \href{https://en.wikipedia.org/wiki/Plasma_(physics)#Mathematical_descriptions}{here}.)}
            
            \BA{Many effects not captured my MHD/2 fluid models (check out \href{https://upload.wikimedia.org/wikipedia/commons/a/a9/A_Comparison_Chart_For_Modeling_Plasma2.png}{this} diagram off Wikipedia, or the ):
            \begin{itemize}
