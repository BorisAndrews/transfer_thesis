\section{FEM vs. PiC Coupling}\label{cha:FEM vs. PiC}
    ...
    \begin{itemize}
        ...
        \begin{equation}
            ...
            \approx  \sum_{i}w_{+}^{(i)}\nabla_{\bfx}\phi\left(\bfX_{+}^{(i)}\right)\cdot\rme\bfV_{+}^{(i)} - \sum_{i}w_{-}^{(i)}\nabla_{\bfx}\phi\left(\bfX_{-}^{(i)}\right)\cdot\rme\bfV_{-}^{(i)}.
        \end{equation}
        ...
        \begin{multline}
            ...
            \approx  \int_{t}\left[\sum_{i}w_{+}^{(i)}\nabla_{\bfx}\phi\left(\bfX_{+}^{(i)}(t)\right)\cdot\rme\bfV_{+}^{(i)}(t) - \sum_{i}w_{-}^{(i)}\nabla_{\bfx}\phi\left(\bfX_{-}^{(i)}(t)\right)\cdot\rme\bfV_{-}^{(i)}(t)\right].
        \end{multline}
