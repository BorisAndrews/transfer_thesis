\section{$\delta\! f$ Models}
    ...
    \BA{Have only just here defined what a $\delta\! f$ method is- currently it just looks like I've taken a nasty kinetic equation, and ended up with a nasty kinetic equation. Clarify that the ``why'' will be in the next section.}

    \BA{Need a note on the symmetry of the collision operators early, and what that implies for those moment lemmas.}
