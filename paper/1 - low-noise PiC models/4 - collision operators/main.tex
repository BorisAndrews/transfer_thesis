\section{Collision Operators Models}\label{cha:collision operators}
    ...
    \begin{definition}[Lénard--Bernstein collision operators \BA{(Have asked Paul Dellar for a good reference here, now just waiting on his response.)}]\label{def:Lénard--Bernstein collision operators}
