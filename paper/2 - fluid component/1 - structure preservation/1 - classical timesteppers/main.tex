\subsection*{Runge--Kutta (RK) Methods}\label{cha:RK methods}
    ...
    The FET-induced timesteppers discussed in Subsubsection \ref{cha:FET} are often analogous to collocation methods, especially for linear problems. Consider the following examples:
