\section{Variational/Weak Reformulation}
    \BA{Introduction.}
    ...
    \input{2 - fluid component/3 - weak reformulations/1 - stationary-state/main.tex}
    \input{2 - fluid component/3 - weak reformulations/2 - periodic/main.tex}
    \input{2 - fluid component/3 - weak reformulations/3 - timestepper/main.tex}
