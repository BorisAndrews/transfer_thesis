\section{Conserved/Dissipated Quantities}
    ...
    where $a$, $b$ satisfy the relation $a + b  =  \frac{4}{\beta\rmRH}$, \BA{(What do these represent \emph{physically}? Diagrams!)} and the vorticity, $\bfomega$, is defined as $\bfomega  :=  \nabla\wedge\bfu$.
