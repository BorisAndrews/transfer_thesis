\section{Conserved/Dissipated Quantities}
    ...
    \end{equation}
    \cite{Laakmann_Hu_Farrell_2022} considers conservation of the following 3 quantities in the incompressible system: \BA{(Oops I've never defined $\bfA$! That should probably be in the introduction...)}
