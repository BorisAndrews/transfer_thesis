\subsubsection*{Transient Case}
    ...
    \end{equation}
    such that, since $(\bfE, \bfB)  \in  \calE\oplus\calB$ lies in this kernel, it lies too in this image, and there exist EM potentials $\varphi$, $\bfA$ such that:
    \begin{align}
    ...
    \begin{figure}
        ...
        {\footnotesize \begin{tikzpicture}[align = center, node distance = 4cm, auto]
            ...
            \node[ellipse, draw, dashed, minimum width = 5cm, minimum height = 2.5cm, rotate = 30] at (2,  - 3) {};
                \node (H1-L2)    at (2 - 0.85,  - 3 - 0.85) {$H^{1}\otimes L^{2}$};
                \node (Hcurl-H1) at (2 + 0.85,  - 3 + 0.85) {$\bfH(\bfcurl)\otimes H^{1}$};
            \node[ellipse, draw, dashed, minimum width = 5cm, minimum height = 2.5cm, rotate = 30] at (7,  - 3) {};
                \node (Hcurl-L2) at (7 - 0.85,  - 3 - 0.85) {$\bfH(\bfcurl)\otimes L^{2}$};
                \node (Hdiv-H1)  at (7 + 0.85,  - 3 + 0.85) {$\bfH(\rmdiv)\otimes H^{1}$};
            \node[ellipse, draw, dashed, minimum width = 5cm, minimum height = 2.5cm, rotate = 30] at (12, - 3) {};
            ...
            \node[ellipse, draw, dashed, minimum width = 4cm, minimum height = 2cm, rotate = 30] at (1,  - 11) {};
                \node (phi) at (1 - 0.85,  - 11 - 0.85) {$\Phi$};
                \node (A)   at (1 + 0.85,  - 11 + 0.85) {$\calA$};
            \node[ellipse, draw, dashed, minimum width = 4cm, minimum height = 2cm, rotate = 30] at (6,  - 11) {};
                \node (E)   at (6 - 0.85,  - 11 - 0.85) {$\calE$};
                \node (B)   at (6 + 0.85,  - 11 + 0.85) {$\calB$};
            \node[ellipse, draw, dashed, minimum width = 4cm, minimum height = 2cm, rotate = 30] at (11, - 11) {};
            ...
            \draw[->] (HL1) -- (2  - 0.75, - 3 + 1.25);
            \draw[->] (HL2) -- (7  - 0.75, - 3 + 1.25);
            \draw[->] (HL3) -- (12 - 0.75, - 3 + 1.25);
            ...
            \draw[->] (phiA) -- (1  - 0.65, - 11 + 1.15);
            \draw[->] (EB)   -- (6  - 0.65, - 11 + 1.15);
            \draw[->] (C*)   -- (11 - 0.65, - 11 + 1.15);
            
            \draw[->] (A)   -- (B) node[above, midway] {$\bfcurl$};
            \draw[->] (A)   -- (E) node[above, midway] {$\partial_{t}$};
            \draw[->] (phi) -- (E) node[above, midway] {$\bfgrad$};
    ...
    \begin{figure}
        ...
        \begin{tikzpicture}[align = center, node distance = 4cm, auto]
            ...
            \node (M) at (- 0.85, - 8.25) {$\calM$};
            \node (D) at (0.85,   - 6.75) {$\calD$};
            \node (P) at (5.65,   - 8.25) {$\calP$};
