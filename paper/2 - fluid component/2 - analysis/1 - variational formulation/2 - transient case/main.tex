\subsubsection*{Transient Case}
    ...
    \begin{figure}
        ...
        {\footnotesize \begin{tikzpicture}[align = center, node distance = 4cm, auto]
            ...
            \draw[->] (HL2) -- (2  - 0.75, - 3 + 1.25);
            \draw[->] (HL3) -- (7  - 0.75, - 3 + 1.25);
            \draw[->] (HL4) -- (12 - 0.75, - 3 + 1.25);
            ...
            \draw[->] (PsiChi) -- (1  - 0.65, - 11 + 1.15);
            \draw[->] (MD)     -- (6  - 0.65, - 11 + 1.15);
            \draw[->] (P*)     -- (11 - 0.65, - 11 + 1.15);
            
            \draw[->] (Chi) -- (D) node[above, midway] {$\rmdiv$};
            \draw[->] (Chi) -- (M) node[above, midway] {$\partial_{t}$};
            \draw[->] (Psi) -- (M) node[above, midway] {$\bfcurl$};
