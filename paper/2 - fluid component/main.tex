\chapter{Fluid Component}
    ...
    On non-relativistic scales where $\rmM  \ll  1$, the quasi-neutrality hypothesis, $\rho_{C}  \sim  0$, is derived. This is assumed henceforth, giving the final quasi-neutral compressible Hall MHD system in Figure \ref{fig:non-dim compressible strong form}, where, with $\rho_{C}$ eliminated, $\rho_{M}$ is denoted as simply $\rho$:
    ...
    \input{2 - fluid component/1 - conserved quantities/main.tex}
    \input{2 - fluid component/2 - structure preservation/main.tex}
    \input{2 - fluid component/3 - weak reformulations/main.tex}
    \input{2 - fluid component/4 - linearization and well-posedness/main.tex}
    \input{2 - fluid component/5 - numerics/main.tex}
