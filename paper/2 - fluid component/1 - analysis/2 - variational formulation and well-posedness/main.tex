\subsection{Variational Formulation and Well-Posedness}
    ...
    \input{2 - fluid component/1 - analysis/2 - variational formulation and well-posedness/1 - stationary state/main.tex}
    \input{2 - fluid component/1 - analysis/2 - variational formulation and well-posedness/2 - transient/main.tex}
