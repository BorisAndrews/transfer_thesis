\subsection{Variational Formulation and Well-Posedness}
    ...
    \input{2 - fluid component/1 - analysis/2 - variational formulation and well-posedness/1 - stationary-state case/main.tex}
    \input{2 - fluid component/1 - analysis/2 - variational formulation and well-posedness/2 - transient case/main.tex}
