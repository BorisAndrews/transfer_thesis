\subsection*{Periodic Case}
    ...
    \begin{figure}
        ...
        \end{tabular}
        \caption{Test spaces for the (compressible) periodic variation formulation \BA{(I introduce ``$\alpha$'' here, but I used $\alpha$ as notation for a small thing in Subsubsection \ref{cha:fluid models})}}
