\subsubsection*{The \emph{Incompressible} Case}
    ...
    \begin{remark}
        \BA{Crucial that non-$\bfgrad$-conforming discretizations preserve this skew-symmetry property for energy dissipation! (In fact, is suff. that $\calC  \leq  0$, such that various \emph{dissipative} fluxes (e.g. upwinding) can be considered.)}
    \end{remark}
