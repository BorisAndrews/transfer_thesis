\section{Constructing Structure-Preserving (SP) Timesteppers}
    ...
    \begin{example}[Heat equation]
        ...
        \end{equation}
        under homogeneous Dirichlet or Neumann BCs. Here, the energy $\rmE(t)  :=  \int_{\bfOmega}u^{2}$ is dissipated according to
    ...
    \begin{example}[Hamiltonian systems]
        ...
        \begin{align}
            ...
            \partial_{t}q  =  + \nabla_{p|_{t}}\calH,
        \end{align}
        for $L^{2}$ functional derivatives $\nabla_{p|_{t}}$, $\nabla_{q|_{t}}$, on $\bbR^{d}$. These exactly conserve the Hamiltonian,
        \begin{equation}
    ...
    \input{2 - fluid component/2 - structure preservation/1 - classical timesteppers/main.tex}
    \input{2 - fluid component/2 - structure preservation/2 - FET/main.tex}
