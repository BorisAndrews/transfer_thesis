\subsubsection{Example 1: The Heat Equation}
    \begin{example}[CG-DG-in-time timestepper for the heat equation]
        Consider the heat equation (\ref{eqn:heat equation}) on $\bfOmega\otimes T^{n}$. We take homogeneous Dirichlet/Neumann BCs, and suppose the ICs, $u|_{t = t^{n}}  =  \widehat{u}_{0}$ hold.
