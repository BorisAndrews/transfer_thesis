\subsubsection*{Example 1: The Heat Equation}
    ...
    \begin{align}
        &\forall              v  \in  \partial_{t}\calU,  &              \langle v, \partial_{t}u\rangle  &=   - \frac{1}{\rmPe}\langle\nabla v, \nabla\widetilde{u}\rangle  \label{eqn:heat equation auxiliary variational form 1}  \\
        &\forall  \widetilde{v}  \in  \partial_{t}\calU,  &  0  &=  \langle \widetilde{v}, \widetilde{u}\rangle - \langle\widetilde{v}, u\rangle  \label{eqn:heat equation auxiliary variational form 2}
    \end{align}
