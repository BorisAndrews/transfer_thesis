\section{Preserved Structures}
    ...
    \BA{Proven that in the \emph{compressible} case, for $E  := 
     \int_{\bfOmega}\left[\frac{1}{2\rho}\|\bfp\|^{2} + p + \frac{1}{\beta}\|\bfB\|^{2}\right]$, $\frac{d\rmE}{dt}$ evaluates as
    {\small \begin{equation}
        \frac{d\rmE}{dt}  =  \int_{\bfGamma}\left(- \frac{1}{2\rho}\|\bfp\|^{2}\bfp - \frac{p}{\rho}\bfp + \frac{1}{\rmRef}\bfsigma\cdot\bfp + \frac{1}{\rmPe}\nabla\left[\frac{p}{\rho}\right] + \frac{1}{\beta}\bfB\wedge\bfE\right)\cdot\bfn
    \end{equation}}}
