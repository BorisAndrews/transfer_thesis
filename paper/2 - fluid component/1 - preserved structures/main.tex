\section{Preserved Structures}
    ...
    \begin{center}\begin{tabular}{ c | r l }
        ...
        Magnetic helicity  &  $\rmH_{\rmM}$  &  $\calH(\bfA)$
    \end{tabular}\end{center}
    \BA{(Not sure about the hybrid helicity, $\rmH_{\rmH}$. I can't get anything to work...)} The time derivative for the energy then includes boundary contributions \emph{only}, \BA{(Proof in appendix?)}
    \begin{equation}
