\section{Preserved Structures}
    ...
    \begin{corollary}
        When $\bfB\wedge\bfn  =  \bfzero|_{\bfgamma}$ for some non-empty $\bfgamma  \subseteq  \bfGamma$, and either the boundary condition $\bfzero  =  (\bfE - \nabla\varphi)\wedge\bfn$ or $\bfzero  =  \bfA\wedge\bfn$ holds on all of $\bfGamma$, and $\bfB\wedge\bfn  =  \bfzero|_{\bfgamma}$, Lemma \ref{lem:continuity of helicity} can be applied to the time derivative of the magnetic helicity, $\rmH_{\rmM}$, giving
        \begin{equation}
