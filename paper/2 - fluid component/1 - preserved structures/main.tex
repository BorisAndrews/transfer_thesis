\section{Preserved Structures}
    ...
    \end{tabular}\end{center}
    \BA{(Not sure about the hybrid helicity, $\rmH_{\rmH}$. I can't get anything to work... Turn this into a remark (with further work/appendix).)} The time derivative for the energy then includes boundary contributions \emph{only}, \BA{(Proof in appendix?)}
    \begin{equation}
