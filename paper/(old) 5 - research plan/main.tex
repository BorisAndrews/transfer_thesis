\chapter{Research Plan}\label{cha:research plan}
    ...
    \BA{I am creating these structure-preserving timesteppers for the MHD component, but that falls down for now when I coupled it to the particles- is there any way I can avoid that? Does the FET approach help? Really interesting question.}
