\subsection*{Fluid Models}\label{cha:fluid models}
    ...
    \begin{lemma}[Momentum conservation on $(\bfC_{ss'})_{ss'}$]
    ...
    \begin{lemma}[Energy conservation on $(\bfC_{ss'})_{ss'}$]
    ...
    \end{lemma}
    \begin{proof}
        \BA{Similar proof to momentum conservation, with leading-order approximations.}
    \end{proof}
