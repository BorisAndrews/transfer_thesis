\subsubsection*{Assumption 2: EM vs. Collisions Dominant Balance}
    ...
    \begin{itemize}
        ...
        \item  $\overline{\bfC}_{ss'}  :=  \max_{s}\{\overline{n}_{s}\}\overline{\bfB}/\max_{s'}\{q_{s'}\}\overline{\bfv}^{2}$, by the requirement of a non-trivial dominant balance, here of the EM terms and collisional terms from phase $s'$ in phase $s$. \BA{(Further justification?)}
    \end{itemize}
