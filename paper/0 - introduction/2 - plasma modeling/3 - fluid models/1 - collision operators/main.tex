\subsubsection*{The Collision Operators: Locality and Models}
    ...
    \end{equation}
    for some $(\bfC_{ss'}^{(0)})_{ss'}$. This extends the results of Lemma \ref{lem:conservation on collision operators}:

    \begin{lemma}[Momentum and energy conservation on $(\bfC_{ss'}^{(0)})_{ss'}$]
