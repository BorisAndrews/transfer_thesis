\chapter{Proofs of Conservation Law in the Weak Formulation}\label{cha:weak conservation proofs}
    ...
    \section*{Periodic case}
        \BA{Again, I've moved this from what was \emph{previously} what I originally had as the timestepper, but I now realize is more valid for the periodic problem. THe phrasing etc. needs to be modified, but the proof is very similar ().}
