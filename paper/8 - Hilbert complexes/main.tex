    ...
    \section{(3+1)D in Space and Time}
        ...
        \subsection*{$H_{0}\Lambda^{\bullet}(\bfOmega\otimes[0, T])$}
            ...
            \begin{align}
                ...
                \bfH_{0}\left(\begin{matrix} \bfgrad + \partial_{t} \\ * - \bfcurl \end{matrix}\right)  &:=  \left\{\begin{pmatrix} u \\ \bfv \end{pmatrix} \in \bfH\left(\begin{matrix} \bfgrad + \partial_{t} \\ * - \bfcurl \end{matrix}\right) : \begin{matrix} u|_{\bfGamma\otimes[0, T]} = 0, \bfv|_{\bfOmega\otimes\{0, T\}} = \bfzero \\ \bfv\wedge\bfn|_{\bfGamma\otimes[0, T]} = \bfzero \end{matrix}\right\}  \\
                H^{1}_{0}  &:=  \left\{v \in H^{1} : \begin{matrix} v = 0|_{\bfOmega\otimes\{0, T\}} \\ v = 0|_{\bfGamma\otimes[0, T]} \end{matrix}\right\}
            \end{align}
