\chapter{Derivation of the Boltzmann Equation}\label{sec:Boltzmann equation derivation}
    ...
    {\small \begin{align}
        ...
        \end{split}
    \end{align}}
    Noting the definition of the collisional force from equation (\ref{eqn:collisional forces}), alongside the explicit identities for $\widetilde{\bfE}$, $\widetilde{\bfB}$,
    \begin{align}
