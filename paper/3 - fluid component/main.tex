    ...
    \input{3 - fluid component/0 - preliminaries and notation/main.tex}
    \input{3 - fluid component/1 - conserved quantities/main.tex}
    \input{3 - fluid component/2 - structure preservation/main.tex}
    \input{3 - fluid component/3 - weak reformulations/main.tex}
    \input{3 - fluid component/4 - linearization and well-posedness/main.tex}
    \input{3 - fluid component/5 - numerics/main.tex}
