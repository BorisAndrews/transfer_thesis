\subsection{Functions Spaces/Finite Elements in Time (FET)}
    ...
    \input{3 - fluid component/2 - structure preservation/2 - FET/1 - heat equation/main.tex}
    \input{3 - fluid component/2 - structure preservation/2 - FET/2 - construction/main.tex}
    \input{3 - fluid component/2 - structure preservation/2 - FET/3 - heat equation (revisited)/main.tex}
    \input{3 - fluid component/2 - structure preservation/2 - FET/4 - Hamiltonian systems/main.tex}
    \input{3 - fluid component/2 - structure preservation/2 - FET/5 - Navier--Stokes/main.tex}
