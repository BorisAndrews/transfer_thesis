\section{Variational/Weak Reformulation}
    ...
    \input{3 - fluid component/3 - weak reformulations/1 - stationary-state/main.tex}
    \input{3 - fluid component/3 - weak reformulations/2 - periodic/main.tex}
    \input{3 - fluid component/3 - weak reformulations/3 - timestepper/main.tex}
