\section{Fluid Models: The \emph{High} Collisionality Limit}
    ...
    \subsection{Single-Phase Fluids}
        ...
        \end{align}
        and, by its definition from the energy equation here, \BA{(Do not like the way that's phrased...)} $k_{B}  \approx  1.381\times10^{- 23}\rmJ\rmK^{- 1}$ is the Boltzmann constant.
