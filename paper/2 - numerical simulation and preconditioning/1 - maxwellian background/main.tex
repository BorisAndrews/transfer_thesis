\section{Maxwellian Background: A Fluid Simulation}
    ...
    \input{paper/2 - numerical simulation and preconditioning/1 - maxwellian background/1 - augmented lagrangian preconditioning/main.tex}
    \input{paper/2 - numerical simulation and preconditioning/1 - maxwellian background/2 - fast diagonalization method/main.tex}