\subsubsection{Tokamak Plasmas}
 ...
 \left[\overline{\bfV} + \delta\bfV\right]dt  \\
    ...
    \end{align}
    we solve each of (\ref{multiscale position SDE}) and (\ref{multiscale velocity SDE}) at each order in $\varepsilon$: \BA{(A lot of technicalities coming up, maybe good to put in an appendix?)}
    \begin{itemize}
