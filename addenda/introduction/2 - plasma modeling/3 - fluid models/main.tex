\subsection{Fluid Models}\label{cha:fluid models}
    ...
    \input{2 - plasma modeling/3 - fluid models/1 - local collisions/main.tex}
    \input{2 - plasma modeling/3 - fluid models/2 - dominant balance/main.tex}
    \input{2 - plasma modeling/3 - fluid models/3 - spatial locality/main.tex}
    \input{2 - plasma modeling/3 - fluid models/4 - thermalization/main.tex}
