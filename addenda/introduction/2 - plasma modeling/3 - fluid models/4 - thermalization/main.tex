\subsubsection*{Assumption 3: Exact Thermalization}
    ...
    \begin{itemize}
        ...
        \end{align}
        for a pressure $p$. \BA{(Is this a safe assumption? I have seen bimaxwellian background distributions being used that might imply not so much, but surely the collisions are still isotropic, no?)}
