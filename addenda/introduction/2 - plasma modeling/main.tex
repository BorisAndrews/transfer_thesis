\section{Modeling: Theory and Simulation}\label{cha:plasma modeling}
    ...
    \input{2 - plasma modeling/1 - particle models/main.tex}
    \input{2 - plasma modeling/2 - kinetic models/main.tex}
    \input{2 - plasma modeling/3 - fluid models/main.tex}
