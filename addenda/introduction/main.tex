...
\title{Addendum: Plasmas and Tokamak Plasmas}
...
\begin{document}
    ...
    \BA{Would like more references for the above subparagraphs.}

    \BA{I think I have got some $\nabla$'s here that should be $\nabla_{\bfx}$'s, especially in Maxwell's equations.}


    \input{1 - plasmas/main.tex}
    \input{2 - plasma modeling/main.tex}
    ...
    \pagenumbering{roman}
    \appendix
        \input{3 - Boltzmann equation derivation/main.tex}
\end{document}
